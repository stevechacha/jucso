...
WSGI_APPLICATION = "jucso_api.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": (
        ...
        "core.permissions.PortalAccessPermission",
    ),
...
FRONTEND_URL = os.environ.get(
    "FRONTEND_URL",
    "http://localhost:5173" if DEBUG else "https://jucso-web-production.up.railway.app",
)
